...
| | |
| :--- | :--- |
| *Official URL*:http://mohcc.gov.zw/fhir/epi/ImplementationGuide/zw.fhir.ig.epi | *Version*:0.1.0 |
| Draft as of 2026-06-16 | *Computable Name*:ZWEpi |
...
* Creating an issue on GitHub [epi repository](https://github.com/WorldHealthOrganization/epi)
...
This is an R4 IG. None of the features it uses are changed in R4B, so it can be used as is with R4B systems. Packages for both [R4 (zw.fhir.ig.epi.r4)](package.r4.tgz) and [R4B (zw.fhir.ig.epi.r4b)](package.r4b.tgz) are available.
...
```json
{
  ...
  "id" : "zw.fhir.ig.epi",
  "url" : "http://mohcc.gov.zw/fhir/epi/ImplementationGuide/zw.fhir.ig.epi",
  "version" : "0.1.0",
  "name" : "ZWEpi",
  "title" : "Zimbabwe EPI IG",
  "status" : "draft",
  "experimental" : false,
  "date" : "2026-06-16T07:36:46+00:00",
  ...
  "description" : "Zimbabwe Expanded Programme on Immunization FHIR Implementation Guide",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://mohcc.gov.zw/fhir/epi/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "name" : "Example Immunization (BCG)",
      "description" : "BCG vaccination given at birth for the example Zimbabwean patient.",
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/epi/StructureDefinition/zw-immunization"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/zw-immunization"
      },
      "name" : "Zimbabwe Immunization",
